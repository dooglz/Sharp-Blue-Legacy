...
void OGL_Renderer::InitDisplay() {
  ...
  _window = SDL_CreateWindow(
      "SDL", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH,
  ...
  // Glewinit always throws an error, due to that experimental flag, just ignore
  // it.
  glGetError();
