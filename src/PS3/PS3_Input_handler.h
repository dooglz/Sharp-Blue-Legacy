...
namespace Engine {
namespace PS3 {
//! port_no Controller number (0-6), this class currently only supports 1
//controller
#define PORT_NO 0
...
const std::string padbuttons_names[16] = {
  "select", "l3", "r3", "start", "dpad_u", "dpad_r", "dpad_d", "dpad_l",
  "l2",     "r2", "l1", "r1",    "y",      "b",      "a",      "x"
};
...
const std::string analogue_names[16] = {
  "rs_x",     "rs_y",     "ls_x", "ls_y", "dpad_r_a", "dpad_l_a",
  "dpad_u_a", "dpad_d_a", "y_a",  "b_a",  "a_a",      "x_a",
  "l1_a",     "r1_a",     "l2_a", "r2_a"
};
