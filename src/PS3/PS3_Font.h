...
public:
  ...
  //! Renders a single character to the specified buffer at the specified
  //position
  void render(const int buffer, const unsigned int character, const float X,
              const float Y);

  //! Renders a string of text to the specified buffer at the specified position
  void renderString(const int buffer, const char* characters, const float X,
                    const float Y);
