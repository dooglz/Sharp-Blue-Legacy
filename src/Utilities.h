...
#elif defined(WIN32) || defined(_WIN32_) || defined(__WIN32__) ||              \
    defined(_WIN32) || defined(_WIN64_) || defined(__CYGWIN__) ||              \
    defined(MINGW32)
#define _WINDOWS_
#define _PC_
